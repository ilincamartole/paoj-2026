...
public class Main {
        ...
        public static void main(String[] args) {
            ...
            while (true) {
                ...
                System.out.println("10. Calculati care buyeri trebuie sa devina PremiumBuyeri si dati le acest statut. Un premiumBuyer a participat la cel putin 3 licitatii");//TODO
                ...
                try {
                    switch (n) {
                        case 1:
                            ...
                            Seller u = (Seller) serviceU.cautaUser(UserType.SELLER, cnp);
                            if (u != null) {
                                scanner.nextLine();
...
//                            }
                        ...
                        case 8:
                            System.out.println("Licitatiile afisate dupa nr de oferte: ");
                            serviceL.afiseazaLicitatiiSortate();
                            break;

                        case 9:
                            System.out.println("Categoria preferata a buyerilor este: ");
                            serviceU.categoriePrefBuyeri();
                            break;

                        case 10:
                            n=serviceU.upgradePremiumBuyers(serviceL.getLicitatii());
